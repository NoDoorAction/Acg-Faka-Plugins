(function () {
    ...
    const api = {
        sessions: "/plugin/LiveChat/adminApi/sessions",
        messages: "/plugin/LiveChat/adminApi/messages",
        reply: "/plugin/LiveChat/adminApi/reply",
        end: "/plugin/LiveChat/adminApi/end"
    };
    ...
    const endSession = () => {
        ...
        if (!window.confirm("确定结束该会话吗？聊天内容会被清理。")) return;
